...
Multiselect.prototype.init = function() {
	...
	this.inputEl.addEventListener('click', () => this.updateMenuState(false));
...
Multiselect.prototype.onInput = function() {
	...
	for(let i = 0; i < this.options.length ; i++){
		if (this.options[i].includes(curValue)){
			...
			document.getElementById("combo1-" + i).onclick = function () {
		       document.getElementById("listbox1").style.display = 'none';
		    };
		}
	}
